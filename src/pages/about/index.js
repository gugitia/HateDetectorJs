    ...
    <div className="app">
      ...
      <div className="main-about">
        ...
        <div className="text">
          ...
          <h4>O dataset</h4>
          <p>
            O dataset foi utilizado para ensinar a ia os padrões de frases
            hostis, ela recebeu essas informações em forma de vetores e criou um
            padrão de linguagem unico para interpretar futuras sentenças. É um
            dataset publico disponivel na keggle pelo{" "}
            <a
          ...
          <p>
            <br />
            <strong>AVISO</strong> <br /> algumas sentenças hostis podem acabar
            passando despercebidas por limitação do dataset perante a capacidade
            do ser humano encontrar formas de ofender alguem.
          </p>
          <h4>A api</h4>
          <p>
